...
const Navbar = ({ setMenuOpen }) => {
  ...
  const dropdown_toggle = (e) => {
    ...
    setMenuOpen(menuRef.current.classList.contains('nav-menu-visible'));
  }
    ...
    <div className='navbar'>
      <div className="nav_logo">
        <Link 
          ...
          to="/"
          onClick={() => setMenu("shop")}   // ✅ logo resets active to shop
        >
      ...
      <div className="nav-login-cart">
        ...
        <Link 
          ...
          to='/cart' 
          onClick={() => setMenu("cart")}   // ✅ clears highlight on cart
        >
